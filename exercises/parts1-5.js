...
// console.log(`The Space Craft Name ${spacecraftName} takes ${daysToMars} days to get to Mars`);
...
// console.log(`The Space Craft Name ${spacecraftName} takes ${getDaysToLocation(kilometersToMars)} days to get to Mars`);
// console.log(`The Space Craft Name ${spacecraftName} takes ${getDaysToLocation(kilometersToTheMoon)} days to get to Mars`);
